...
private extension ViewController {
    ...
    var uplynkAds: UplynkServerSideAdIntegrationConfiguration {
        UplynkServerSideAdIntegrationConfiguration(assetIDs: ["41afc04d34ad4cbd855db52402ef210e",
    ...
    var uplynkLive: UplynkServerSideAdIntegrationConfiguration {
        UplynkServerSideAdIntegrationConfiguration(assetIDs: ["3c367669a83b4cdab20cceefac253684"],
                                                   externalIDs: [],
                                                   assetType: .channel,
                                                   prefix: "https://content.uplynk.com",
                                                   userID: nil,
    ...
    var uplynkDRM: UplynkServerSideAdIntegrationConfiguration {
        UplynkServerSideAdIntegrationConfiguration(assetIDs: ["e973a509e67241e3aa368730130a104d",
