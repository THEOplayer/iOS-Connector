...
struct WebSourceMeta: CustomStringConvertible {
    var description: String {
        "type: \(type) ads: \(ads)"
    }
    
    let type: UplynkSSAIConfiguration.AssetType
    let ads: Bool
}
...
extension WebSource {
    ...
    static let source1 = WebSource(url: URL(string: "https://content.uplynk.com/player5/3D0PYRlstKHws59xA190jfsa.html")!,
                                   ...
                                   tokenRequired: true,
                                   meta: WebSourceMeta(type: .asset, ads: false))
    ...
    // LIVE sources:
    static let source6 = WebSource(url: URL(string: "https://content.uplynk.com/player5/607exUNBJDf260nEJrrxtRsa.html")!,
                                    assetID: "cbf7d83f86d14a64b1df75386d5c4536",
                                    externalID: nil,
                                    userID: nil,
                                    tokenRequired: true,
                                    meta: WebSourceMeta(type: .channel, ads: false))
