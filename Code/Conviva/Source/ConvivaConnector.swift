...
public struct ConvivaConnector {
    ...
    public func reportCustomPlaybackEvent(eventName: String, attributes: [String: Any]) {
        self.endPoints?.videoAnalytics.reportPlaybackEvent(eventName, withAttributes: attributes)
    }
