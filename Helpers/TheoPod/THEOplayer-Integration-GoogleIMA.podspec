...
Pod::Spec.new do |spec|
  ...
  spec.name         = "THEOplayer-Integration-GoogleIMA"
  ...
  spec.ios.vendored_frameworks = "Frameworks/THEOplayerGoogleIMAIntegration.xcframework"
  
  spec.ios.dependency 'GoogleAds-IMA-iOS-SDK', '3.18.4'
